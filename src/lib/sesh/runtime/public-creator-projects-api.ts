...
export interface PublicSeshCreatorProjectsApiRuntimeEnvironment {
  readonly SESH_DB?:
    unknown;
}
...
export function createPublicSeshCreatorProjectCollectionAtRuntime(
  runtimeEnvironment:
  ...
  if (
    ...
    throw new TypeError(
      "Public Sesh creator project collection runtime environment is required.",
    );
  }
  ...
  return new DefaultPublicSeshCreatorProjectCollectionService({
    reservations:
